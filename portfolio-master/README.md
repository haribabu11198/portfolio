...
🚀 **[Dev Portfolio V2 has arrived. Meet Devfolio, a modern portfolio + blog template built with GatsbyJS and TailwindCSS](https://github.com/haribabu11198/devfolio)** 🚀
...
To view a live demo, [click here](https://haribabu11198.github.io/devportfolio/).

Looking for a blog template? Checkout [DevBlog](https://github.com/haribabu11198/devblog).
...
The experience section creates a vertical timeline with all your relevant experience. The code for the timeline creation can be found within `js/scripts.js` and is an adaptation of [RyanFitzgerald/vertical-timeline](https://github.com/haribabu11198/vertical-timeline).
